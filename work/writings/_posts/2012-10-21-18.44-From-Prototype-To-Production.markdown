...
Lets add thos docstrings and silence the missing member functions tha we know
...
The code written during this writing can be cloned from:
* https://github.com/rlgomes/kvs
